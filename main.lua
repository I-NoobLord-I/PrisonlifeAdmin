...
local wallpaper = Instance.new("ImageButton")
...
Background.Position = UDim2.new(0.342053145, 0, 0.0329676941, 0)
Background.Size = UDim2.new(0, 350, 0, 350)

CmdName.Name = "CmdName"
CmdName.Parent = Background
CmdName.BackgroundColor3 = Color3.fromRGB(36, 148, 255)
...
FindCmd.Position = UDim2.new(0, 0, 0.0628571436, 0)
FindCmd.Size = UDim2.new(0, 350, 0, 22)
...
CmdHandler.VerticalScrollBarPosition = Enum.VerticalScrollBarPosition.Left
...
Minimum.BackgroundColor3 = Color3.fromRGB(182, 188, 48)
...
UICorner_2.Parent = Minimum

Close.Name = "Close"
Close.Parent = Background
Close.BackgroundColor3 = Color3.fromRGB(232, 0, 7)
...
Close.MouseButton1Click:Connect(function()
	Background:TweenPosition(
		UDim2.new(0.039,0 , 1,-2),           -- Final position the tween should reach
		Enum.EasingDirection.In, -- Direction of the easing
		Enum.EasingStyle.Sine,   -- Kind of easing to apply
		0.2,                       -- Duration of the tween in seconds
		true
	)
	wait(0.2)
...
close.Position = UDim2.new(0, 0, 7.4505806e-09, 0)
close.Size = UDim2.new(0, 20, 0, 20)
close.ZIndex = 2
...
Background2.Position = UDim2.new(0.039,0 , 1,-2)
Background2.Size = UDim2.new(0, 904, 0, 51)
Background2.Visible = false

Label.Name = "Label"
Label.Parent = Background2
Label.BackgroundColor3 = Color3.fromRGB(36, 148, 255)
Label.BorderSizePixel = 0
Label.Position = UDim2.new(0, 0, 0.01950798, 0)
Label.Size = UDim2.new(0, 904, 0, 23)
...
Execute.Position = UDim2.new(0, 0, 0.442677319, 0)
Execute.Size = UDim2.new(0, 904, 0, 25)
Execute.Font = Enum.Font.SourceSans
Execute.PlaceholderColor3 = Color3.fromRGB(255, 255, 255)
Execute.PlaceholderText = "Press ; To Enter"
Execute.Text = ""
Execute.TextColor3 = Color3.fromRGB(255, 255, 255)
Execute.TextSize = 16.000
Execute.TextWrapped = true

UICorner_6.Parent = Background2
...
CloseBar.Font = Enum.Font.Cartoon
CloseBar.MouseButton1Click:Connect(function()
	Background4:TweenPosition(
		UDim2.new(0.039,0 , 1,-2),           -- Final position the tween should reach
		Enum.EasingDirection.In, -- Direction of the easing
		Enum.EasingStyle.Sine,   -- Kind of easing to apply
		0.2,                       -- Duration of the tween in seconds
...
UICorner_9.Parent = CloseBar

close_2.Name = "close"
close_2.Parent = CloseBar
...
TransparencyBar.BackgroundColor3 = Color3.fromRGB(24, 193, 193)
...
UICorner_10.Parent = TransparencyBar

wallpaper.Name = "wallpaper"
wallpaper.Parent = TransparencyBar
wallpaper.BackgroundTransparency = 1.000
wallpaper.LayoutOrder = 8
wallpaper.Position = UDim2.new(0.0799999982, 0, 0.0799999982, 0)
wallpaper.Size = UDim2.new(0, 20, 0, 20)
wallpaper.ZIndex = 2
wallpaper.Image = "rbxassetid://3926305904"
wallpaper.ImageRectOffset = Vector2.new(444, 364)
wallpaper.ImageRectSize = Vector2.new(36, 36)
wallpaper.Visible = false

UICorner_11.Parent = Background4

local Versions = "6.0"
local Cmd = {}

Cmd[#Cmd + 1] = {Text = "Version "..Versions,Title = "Script Version."}
Cmd[#Cmd + 1] = {Text = "Script by LocalPlayer#7434",Title = "UI by Tickle Tipson#0777."}
Cmd[#Cmd + 1] =	{Text = "cmd / cmds",Title = "Show commands"}
Cmd[#Cmd + 1] =	{Text = "console / output",Title = "Show command output"}
Cmd[#Cmd + 1] =	{Text = "rejoin / rj",Title = "Rejoin the game"}
Cmd[#Cmd + 1] =	{Text = "leave / leaveserver / quit",Title = "Leave the server"}
Cmd[#Cmd + 1] =	{Text = "admin / giveadmin [plr]",Title = "Give admin commands to player"}
Cmd[#Cmd + 1] =	{Text = "unadmin / removeadmin [plr]",Title = "Remove admin commands from player"}
...
Cmd[#Cmd + 1] =	{Text = "nokillaura / unkillaura",Title = "Deactivate kill aura"}
Cmd[#Cmd + 1] = {Text = "antifling",Title = "Activate anti fling"}
Cmd[#Cmd + 1] = {Text = "unantifling",Title = "Deactivate anti fling"}
Cmd[#Cmd + 1] = {Text = "god",Title = "Enable god mode"}
Cmd[#Cmd + 1] = {Text = "ungod",Title = "Disable god mode"}
Cmd[#Cmd + 1] =	{Text = "view / spectate / watch [plr]",Title = "Spectates player"}
Cmd[#Cmd + 1] =	{Text = "unview / unspectate / stopwatch",Title = "Unspectates player"}
Cmd[#Cmd + 1] =	{Text = "fastpunch / speedpunchh",Title = "Activate fast punch"}
Cmd[#Cmd + 1] =	{Text = "slowpunch / nofastpunch / normalspeedpunch",Title = "Deactivate fast punch"}
Cmd[#Cmd + 1] =	{Text = "superpunch / onepunch",Title = "Activate super punch"}
Cmd[#Cmd + 1] =	{Text = "nosuperpunch / normalpunch",Title = "Deactivate super punch"}
...
Cmd[#Cmd + 1] = {Text = "clip / clips",Title = "Deactivate no clips"}
...
Cmd[#Cmd + 1] =	{Text = "unautogun / unautoguns / unautoallguns",Title = "Deactivate auto gun when respawned"}
...
Cmd[#Cmd + 1] =	{Text = "antifell / antivoid",Title = "Activate anti-fall into the void when respawned as custom team"}
Cmd[#Cmd + 1] =	{Text = "unantifell / unantivoid",Title = "Deactivate anti-fall into the void when respawned as custom team"}
...
Cmd[#Cmd + 1] = {Text = "unantispamarrest",Title = "Deactivate anti spam arrest"}
Cmd[#Cmd + 1] = {Text = "killscript",Title = "Kills script."}
...
function PlayerChatted(Message)
	...
	if Command("cmd") or Command("cmds") then
		if Background.Visible == true then
			...
			Background:TweenPosition(
				UDim2.new(0.342053145, 0, 0.0329676941, 0),
				Enum.EasingDirection.In, -- Direction of the easing
				Enum.EasingStyle.Sine,   -- Kind of easing to apply
				0.2,                       -- Duration of the tween in seconds
				true
	...
	if Command("console") or Command("output") then
		if Background4.Visible == true then
			Background4:TweenPosition(
				UDim2.new(0.039,0 , 1,-2),           -- Final position the tween should reach
				Enum.EasingDirection.In, -- Direction of the easing
				Enum.EasingStyle.Sine,   -- Kind of easing to apply
	...
	if Command("killscript") then
		game.CoreGui.CmdGui:Destroy()
	end
...
game.Players.LocalPlayer:GetMouse().KeyDown:Connect(function(Key)
	if Key == Prefix then
		if Prefix ~= "/" then
			...
			Background2:TweenPosition(
				UDim2.new(0.039,0, 0.822,-2),           -- Final position the tween should reach
				Enum.EasingDirection.In, -- Direction of the easing
				Enum.EasingStyle.Sine,   -- Kind of easing to apply
